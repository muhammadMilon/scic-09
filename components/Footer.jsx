...
export default function Footer() {
  ...
  return (
    <footer className="bg-white text-dark-900 py-16 border-t border-dark-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="col-span-1 md:col-span-2 space-y-6">
            ...
            <div className="flex space-x-5">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-dark-50 flex items-center justify-center text-dark-400 hover:bg-primary-600 hover:text-white transition-all duration-300 hover:-translate-y-1"
                aria-label="GitHub"
              >
          ...
          {/* Contact */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-dark-900 mb-6">Contact Us</h4>
            <ul className="space-y-4 text-dark-600 text-sm">
        ...
        <div className="border-t border-dark-100 mt-12 pt-8 text-center">
          <p className="text-dark-400 text-[10px] uppercase font-bold tracking-widest">
            &copy; {currentYear} NextMind Academy. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
